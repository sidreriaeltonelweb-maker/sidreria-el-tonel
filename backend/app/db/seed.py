...
db = SessionLocal()
admin_email = os.getenv("ADMIN_EMAIL", "admin@sidreriaeltonel.local").strip().lower()
...
if not admin:
    ...
    db.add(admin)
elif admin_password and not verify_password(admin_password, admin.password_hash):
